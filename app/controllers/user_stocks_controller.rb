class UserStocksController < ApplicationController
  ...
  def create
    # procitati obavezno vise puta jer ova metoda se oslanja na koriscenje objekata iz stock modela
    if params[:stock_id].present?
      ...
      if stock
        ...
        if stock.save
          ...
          @user_stock = nil
          flash[:error] = "Stack is not available!"
        end
      end
    end
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'Stock was successfully removed from portoflio!' }
